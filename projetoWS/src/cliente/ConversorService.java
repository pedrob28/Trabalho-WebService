 ...
 * 
 */
@WebServiceClient(name = "ConversorService", targetNamespace = "http://controle/", wsdlLocation = "http://localhost:8888/conversor?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8888/conversor?wsdl");
    ...
    public Temperatura getConversorPort() {
        return super.getPort(new QName("http://controle/", "ConversorPort"), Temperatura.class);
    }
     ...
     */
    @WebEndpoint(name = "ConversorPort")
    public Temperatura getConversorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://controle/", "ConversorPort"), Temperatura.class, features);
    }
